/**
 * Copia directa de apps/web/src/utils/fuzzy.ts — función pura, sin
 * dependencias de DOM, portable sin cambios. Usada por el buscador de
 * paciente/producto de los accesos rápidos del Home.
 */
